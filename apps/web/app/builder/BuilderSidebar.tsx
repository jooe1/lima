...
export default function BuilderSidebar() {
  ...
  return (
    <aside style={{
      width: 220, borderRight: '1px solid #1f1f1f', flexShrink: 0,
      ...
      <div style={{ padding: '0 1rem 1rem', borderBottom: '1px solid #1f1f1f' }}>
        ...
        {company && (
          <p style={{ color: '#555', fontSize: '0.75rem', margin: '0.25rem 0 0' }}>{company.name || company.slug}</p>
        )}
      </div>
        ...
        <div style={{ padding: '0.75rem 1rem', borderBottom: '1px solid #1f1f1f' }}>
          <select
            ...
            style={{
              ...
              color: '#ccc', borderRadius: 6, padding: '0.4rem 0.5rem', fontSize: '0.8rem',
            }}
          >
            {workspaces.map(ws => (
      ...
      <div style={{ padding: '0.75rem 1rem', borderTop: '1px solid #1f1f1f' }}>
        <p style={{ color: '#555', fontSize: '0.75rem', margin: '0 0 0.5rem' }}>{user?.id?.slice(0, 8)}…</p>
        <button
          onClick={handleSignOut}
          style={{
            background: 'none', border: '1px solid #333', color: '#888',
            borderRadius: 6, padding: '0.3rem 0.75rem', fontSize: '0.75rem', cursor: 'pointer',
          }}
        >
          Sign out
        </button>
